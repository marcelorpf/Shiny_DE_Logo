...
s <- sticker(imgurl, package="Shiny@DE",
             s_x=1, s_y=1.6, s_width=.2,
             p_size=60, p_y = 1, p_family = "speciale", p_color = "black",
...
s = s+geom_text(aes(x = 1, y = .5, label = ">runApp()", family = "speciale"), size = 30, angle = 0)
